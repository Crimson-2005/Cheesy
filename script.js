...
function spawnBats(){
  ...
  for(let i=0;i<10;i++){
    ...
    bat.className="bat";
    bat.style.background="white"; // ensure white color
...
function fadeInMusic(){
  ...
  let fade=setInterval(()=>{
    if(v<0.4){ v+=0.01; music.volume=v; } 
...
function startGame(){
  ...
  // stop birthday & start batman theme
  document.getElementById("birthdayBgm").pause();
  document.getElementById("batmanBgm").currentTime=0;
  document.getElementById("batmanBgm").play();
...
function unlockSecret(){
  ...
  // stop batman & play meow
  document.getElementById("batmanBgm").pause();
  document.getElementById("meowSfx").play();
